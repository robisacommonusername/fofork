...
if ($_POST['install_confirmed'] == 'yes' && isset($_POST['password']) && isset($_POST['password2'])) {
	if ($_POST['password'] === $_POST['password2']) {
		...
		fof_query("insert into $FOF_CONFIG_TABLE (param, val) values ('version', ?), ('bcrypt_effort', ?), ('log_password', ?), ('logging', '0'), ('autotimeout', '10'), ('manualtimeout', '5'), ('purge', '7'), ('max_items_per_request', '100')", array(FOF_VERSION, BCRYPT_EFFORT, fof_make_salt()), False);
