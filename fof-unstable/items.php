...
<p><?php echo $title #NO ESCAPING OF UNTRUSTED INPUT: XSS!?></p> 
...
<?php
	#SECURITY - XSS, $links contains data from $_GET which hasn't been checked, etc
...
#checking for SQL injection - safe
